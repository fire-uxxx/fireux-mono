<template>
  <div v-if="professional" class="profile-card profile-variant">
    <!-- Profile Header -->
    <div class="profile-header">
      ...
      <div class="profile-info-section">
        <h1 class="profile-title">{{ professional.professional_name || professional.displayName }}</h1>
        <p v-if="professional.title" class="profile-subtitle">
          {{ professional.title }}
        </p>
        <div v-if="professional.email" class="profile-contact">
