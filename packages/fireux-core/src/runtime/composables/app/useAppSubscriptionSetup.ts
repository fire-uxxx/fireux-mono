...
import { useCreateProductState } from '../firestore/objects/Product/useCreateProductState'
import { useCreatePricesState } from '../firestore/objects/Product/Prices/useCreatePricesState'
import { useProductCreate } from '../firestore/objects/Product/useProductCreate'
...
export function useAppSubscriptionSetup() {
  ...
  async function createAppSubscriptionProducts(
    ...
    console.log(
      `🚀 [createAppSubscriptionProducts] Setting up subscriptions for ${appName}`
    )
